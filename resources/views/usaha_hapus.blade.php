...
@section('title') Hapus Data Usaha | @stop
@section('content')

<div class="container">
    <h2><b>HAPUS DATA USAHA</b></h2>
    {{ Form::open(['url' => URL('admin/data-usaha/$data->id/hapus/proses')]) }}
    {{ Form::hidden('id',$data->id) }}
    {{ Form::label('idUsers','Nama Pemilik') }}
    <select name="idUsers" class="form-control" readonly="readonly">
    ...
    {{ Form::text('namaUsaha', $data->namaUsaha, ['class' => 'form-control','readonly' => 'readonly']) }}
    <p></p>
    {{ Form::label('alamat','Alamat') }}
    {{ Form::text('alamat', $data->alamat, ['class' => 'form-control','readonly' => 'readonly']) }}
    <p></p>
    {{ Form::label('telepon','Telepon') }}
    {{ Form::text('telepon', $data->telepon, ['class' => 'form-control','readonly' => 'readonly']) }}
    <p></p>
    {{ Form::label('lat','Latitude') }}
    {{ Form::text('lat', $data->lat, ['class' => 'form-control','readonly' => 'readonly']) }}
    <p></p>
    {{ Form::label('lng','Longitude') }}
    {{ Form::text('lng', $data->lng, ['class' => 'form-control','readonly' => 'readonly']) }}
    <p></p>
    {{ Form::label('deskripsi','Deskripsi') }}
    {{ Form::text('deskripsi', $data->deskripsi, ['class' => 'form-control','readonly' => 'readonly']) }}
    <p></p>
    {{ Form::label('produk_unggulan','Produk Unggulan') }}
    {{ Form::text('produk_unggulan', $data->produk_unggulan, ['class' => 'form-control','readonly' => 'readonly']) }}
    <p></p>
    {{ Form::label('gambar_foto','File Foto') }}
    {{ Form::text('gambar_foto', $data->gambar_foto, ['class' => 'form-control','readonly' => 'readonly']) }}
    <p></p>
    {{ Form::label('idSkala','Skala') }}
    <select name="idSkala" class="form-control" readonly="readonly">
    ...
    <select name="idSektor" class="form-control" readonly="readonly">
    ...
    <select name="idKel" class="form-control" id="kec" readonly="readonly">
